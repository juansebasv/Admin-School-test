 ...
 */
@FacesConverter("parentescoFamiliarConvertJSF")
public class ParentescoFamiliarConvertJSF implements Converter {
    ...
    public String getAsString(FacesContext context, UIComponent component, Object value) {
        if (value == null || value.equals("")) {
            ...
            return String.valueOf(((ParentescoFamilia) value).getParentescoFamiliaId());
        }
    }
